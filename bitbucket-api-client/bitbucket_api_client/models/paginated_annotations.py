...
T = TypeVar("T", bound="PaginatedAnnotations")
...
class PaginatedAnnotations:
    ...
    Attributes:
        page (Union[Unset, int]): Page number of the current results. This is an optional element that is not provided
            in all responses.
        values (Union[Unset, List[ReportAnnotation]]): The values of the current page.
    ...
    values: Union[Unset, List[ReportAnnotation]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = ReportAnnotation.from_dict(values_item_data)
        ...
        paginated_annotations.additional_properties = d
        return paginated_annotations
