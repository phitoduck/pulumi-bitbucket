...
T = TypeVar("T", bound="PaginatedReports")
...
class PaginatedReports:
    ...
    Attributes:
        page (Union[Unset, int]): Page number of the current results. This is an optional element that is not provided
            in all responses.
        values (Union[Unset, List[Report]]): The values of the current page.
    ...
    values: Union[Unset, List[Report]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = Report.from_dict(values_item_data)
        ...
        paginated_reports.additional_properties = d
