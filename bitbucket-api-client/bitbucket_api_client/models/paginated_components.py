...
T = TypeVar("T", bound="PaginatedComponents")
...
class PaginatedComponents:
    ...
    Attributes:
        ...
        values (Union[Unset, List[Component]]):
    """
    ...
    values: Union[Unset, List[Component]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = Component.from_dict(values_item_data)

            values.append(values_item)

        paginated_components = cls(
            size=size,
            page=page,
            pagelen=pagelen,
            next_=next_,
