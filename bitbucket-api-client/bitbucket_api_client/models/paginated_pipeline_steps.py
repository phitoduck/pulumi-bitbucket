...
T = TypeVar("T", bound="PaginatedPipelineSteps")
...
class PaginatedPipelineSteps:
    ...
    Attributes:
        page (Union[Unset, int]): Page number of the current results. This is an optional element that is not provided
            in all responses.
        values (Union[Unset, List[PipelineStep]]): The values of the current page.
    ...
    values: Union[Unset, List[PipelineStep]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = PipelineStep.from_dict(values_item_data)
        ...
        paginated_pipeline_steps.additional_properties = d
        return paginated_pipeline_steps
