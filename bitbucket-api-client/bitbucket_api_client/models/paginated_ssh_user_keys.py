...
T = TypeVar("T", bound="PaginatedSSHUserKeys")
...
class PaginatedSSHUserKeys:
    ...
    Attributes:
        ...
        values (Union[Unset, List[SshAccountKey]]):
    """
    ...
    values: Union[Unset, List[SshAccountKey]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = SshAccountKey.from_dict(values_item_data)

            values.append(values_item)

        paginated_ssh_user_keys = cls(
            size=size,
            page=page,
            pagelen=pagelen,
            next_=next_,
        ...
        return paginated_ssh_user_keys
