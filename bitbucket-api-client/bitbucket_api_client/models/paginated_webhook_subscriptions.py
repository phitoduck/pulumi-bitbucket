...
T = TypeVar("T", bound="PaginatedWebhookSubscriptions")
...
class PaginatedWebhookSubscriptions:
    ...
    Attributes:
        ...
        values (Union[Unset, List[WebhookSubscription]]):
    """
    ...
    values: Union[Unset, List[WebhookSubscription]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = WebhookSubscription.from_dict(values_item_data)

            values.append(values_item)

        paginated_webhook_subscriptions = cls(
            size=size,
            page=page,
            pagelen=pagelen,
            next_=next_,
        ...
        return paginated_webhook_subscriptions
