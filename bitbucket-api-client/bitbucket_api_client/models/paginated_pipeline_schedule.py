...
T = TypeVar("T", bound="PaginatedPipelineSchedule")


@attr.s(auto_attribs=True)
class PaginatedPipelineSchedule:
    ...
    Attributes:
        page (Union[Unset, int]): Page number of the current results. This is an optional element that is not provided
            in all responses.
        values (Union[Unset, List[PipelineSchedule]]): The values of the current page.
    ...
    values: Union[Unset, List[PipelineSchedule]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = PipelineSchedule.from_dict(values_item_data)
        ...
        paginated_pipeline_schedule = cls(
            page=page,
            values=values,
            size=size,
            pagelen=pagelen,
        ...
        paginated_pipeline_schedule.additional_properties = d
        return paginated_pipeline_schedule
