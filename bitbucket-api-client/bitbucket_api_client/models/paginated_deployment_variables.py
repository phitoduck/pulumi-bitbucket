...
T = TypeVar("T", bound="PaginatedDeploymentVariables")


@attr.s(auto_attribs=True)
class PaginatedDeploymentVariables:
    ...
    Attributes:
        page (Union[Unset, int]): Page number of the current results. This is an optional element that is not provided
            in all responses.
        values (Union[Unset, List[DeploymentVariable]]): The values of the current page.
    ...
    values: Union[Unset, List[DeploymentVariable]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = DeploymentVariable.from_dict(values_item_data)
        ...
        paginated_deployment_variables = cls(
            page=page,
            values=values,
            size=size,
            pagelen=pagelen,
        ...
        paginated_deployment_variables.additional_properties = d
        return paginated_deployment_variables
