...
T = TypeVar("T", bound="PaginatedIssueAttachment")


@attr.s(auto_attribs=True)
class PaginatedIssueAttachment:
    ...
    Attributes:
        ...
        values (Union[Unset, List[IssueAttachment]]):
    """
    ...
    values: Union[Unset, List[IssueAttachment]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = IssueAttachment.from_dict(values_item_data)

            values.append(values_item)

        paginated_issue_attachment = cls(
            size=size,
            page=page,
            pagelen=pagelen,
            next_=next_,
        ...
        return paginated_issue_attachment
