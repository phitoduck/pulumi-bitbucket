...
T = TypeVar("T", bound="PaginatedMilestones")
...
class PaginatedMilestones:
    ...
    Attributes:
        ...
        values (Union[Unset, List[Milestone]]):
    """
    ...
    values: Union[Unset, List[Milestone]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for values_item_data in _values or []:
            values_item = Milestone.from_dict(values_item_data)

            values.append(values_item)

        paginated_milestones = cls(
            size=size,
            page=page,
            pagelen=pagelen,
            next_=next_,
