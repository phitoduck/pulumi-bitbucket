...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/users/{selected_user}/search/code".format(client.base_url, selected_user=selected_user)
...
def sync_detailed(
    ...
    *,
    ...
    ```
    curl 'https://api.bitbucket.org/2.0/users/{ed08f5e1-605b-4f4a-aee4-
    6c97628a673e}/search/code?search_query=foo'
    {
      \"size\": 1,
      \"page\": 1,
      \"pagelen\": 10,
    ...
    ```
    curl 'https://api.bitbucket.org/2.0/users/{ed08f5e1-605b-4f4a-aee4-
    6c97628a673e}/search/code?search_query=foo+repo:demo'
