...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/repositories/{workspace}/{repo_slug}/watchers".format(
...
def _parse_response(*, response: httpx.Response) -> Optional[PaginatedAccounts]:
...
def _build_response(*, response: httpx.Response) -> Response[PaginatedAccounts]:
    return Response(
